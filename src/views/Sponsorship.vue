  ...
  <v-container fill-height fluid grid-list-xl>
    <v-layout justify-center wrap>
      <v-flex xs12 md4>
        <material-card
          color="green"
          title="Sponsorship Configuration"
          text="This is a list of all the sponsorship configurations"
        >
    ...
    <v-dialog v-model="dialogVisible" width="800px">
      <v-card>
        <v-card-title class="grey lighten-4 py-4 title">Add Sponsorship Configuration</v-card-title>
        <v-card-text>
...
export default {
  methods: {
    ...
    ...mapMutations({
      saveToStore: "addSponsorship"
    })
  },
  computed: mapState({
    items: state => state.sponsorship
  }),
  data: () => ({
    search: "",
    dialogVisible: false,
